...
public class EnglishMainCode {
    ...
    // Intro Method of the English version of the App.
    public static void englishIntroductionOfficialAccount() {
        ...
        // 5 Steps to create the personal "official" (goverment) account. App profile with e-mail etc will be created later.
        ...
        scanner.nextLine();
            ...
            if(profileAge < 18){
                ...
                System.out.println(" ");
                System.out.println("Please confirm that the following information is correct and truthfull!");
                ...
                System.out.println(" ");
                System.out.println("Is this information thruthfull and correct? [yes / no]");
